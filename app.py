...
if predict_clicked or st.session_state.get("make_prediction", False):
...
<div style="text-align:center; padding:15px;">
    <h3 style="color:#6a0dad;">🌸 Iris Flower Classification</h3>
    <p>Built using <b>Streamlit</b> | <b>Scikit-learn</b> | <b>Python</b></p>
    <p>👩‍💻 <b>Developed by Nejitha Sulfikkar</b></p>
</div>
""", unsafe_allow_html=True)
